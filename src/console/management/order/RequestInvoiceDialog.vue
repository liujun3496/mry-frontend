<template>
  <el-dialog v-if="invoiceTitle"
    ...
    <el-alert :closable="false"
              ...
              title="当前支持开具电子版的增值税普通发票和增值税专用发票。根据国家相关法律，电子发票和纸质发票具有同等法律效力。国脉资产云当前为小规模纳税人，根据当前国家对小规模纳税人的税收优惠政策，所开具增值税发票的税率为1%，如果此税率无法满足您的预期，请联系国脉资产云客服为您免费延长相应套餐时限，以作补偿。"
              type="warning">
    </el-alert>
